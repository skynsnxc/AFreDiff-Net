...
def estimate_model_inference_memory_usage(model, val_loader, name='AFreDiff-Net', device='cpu'):
    model.to(device)
    parameter_memory = 0
...
def parse_args():
   ...
   # parser.add_argument('--name', default="ph2_AFreDiff-Net_Net_woDS",
   #                     help='model name')
   #parser.add_argument('--name', default="isic2017_AFreDiff-Net_Net_woDS",
   #                   help='model name')
    parser.add_argument('--name', default="isic2018_AFreDiff-Net_Net_woDS",
                        help='model name')
    # dataset
    ...
    parser.add_argument('--input_h', default=256, type=int,
                        help='image height')
    parser.add_argument('--arch', default='AFreDiff-Net_Net', type=str,
                        help='model')
